  ...
  return new Vuex.Store({
    ...
    actions: {
      async getRates ({ commit }) {
        ...
        const response1 = await axios.get('https://api.exchangeratesapi.io/latest?symbols=USD,RUB')
        const response2 = await axios.get('https://api.exchangeratesapi.io/latest?base=USD&symbols=EUR,RUB')
        const response3 = await axios.get('https://api.exchangeratesapi.io/latest?base=RUB&symbols=EUR,USD')
